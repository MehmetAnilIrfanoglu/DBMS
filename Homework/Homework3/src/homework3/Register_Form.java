...
public class Register_Form extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton1.setText("Have Account? Log in");
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(jTextField_email, javax.swing.GroupLayout.DEFAULT_SIZE, 220, Short.MAX_VALUE)
    ...
    private void jButton_RegisterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_RegisterActionPerformed
        ...
        if(verifySpaces()){
            if(!checkUser(user_name)){
                ...
                ResultSet rs;
                String user_regist = "INSERT INTO `users`(`Name`, `username`, `password`, `Gender`, `Phone`, `email`) VALUES (?,?,?,?,?,?)";
                ...
                try {
                    ...
                    lf.setLocationRelativeTo(null);
                     this.dispose();
                        ...
                        JOptionPane.showMessageDialog(null, "Error. User couldn't created");
                    }
    ...
    private void jTextField_emailFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_jTextField_emailFocusLost
        ...
        String email = jTextField_email.getText();//checkin is format for mail is correct
        if (isValid(email)){
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        Login_Form lf = new Login_Form();//return login page
    ...
    public boolean verifySpaces(){//check if there is / are gaps in sections
        String fname = jTextField_Name.getText();
        String user_name = jTextField_Username.getText();
        String password = String.valueOf(jPasswordField_password.getPassword());
        String confirm_password = String.valueOf(jPasswordField_confirm_password.getPassword());
    ...
    public boolean checkUser(String user){//in order to see if there is a person called with same name in database
        ...
        try {
            ...
            if (rs.next()){
               is_user = true;
               JOptionPane.showMessageDialog(null, "User Exists! Try another Username.","User Conflict",2);// user exists error
            }
